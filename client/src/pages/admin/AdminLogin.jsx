    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="p-4 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-2xl">
              <Shield className="w-12 h-12 text-white" />
            </div>
          </div>
          <h1 className="text-4xl font-bold text-white mb-4">Admin Portal</h1>
          <p className="text-xl text-gray-300 mb-12">Manage brokers, users & trading</p>
          
          <div className="grid grid-cols-2 gap-6 max-w-md">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-left">
              <Users className="w-8 h-8 text-blue-400 mb-3" />
              <h3 className="font-semibold text-white mb-1">Broker Management</h3>
              <p className="text-sm text-gray-400">Create & manage brokers</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-left">
              <BarChart3 className="w-8 h-8 text-cyan-400 mb-3" />
              <h3 className="font-semibold text-white mb-1">User Control</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-left">
              ...
              <p className="text-sm text-gray-400">Handle deposits & withdrawals</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-left">
              <Lock className="w-8 h-8 text-yellow-400 mb-3" />
              <h3 className="font-semibold text-white mb-1">Secure Access</h3>
              <p className="text-sm text-gray-400">Protected admin panel</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="bg-dark-800/80 backdrop-blur-xl p-8 rounded-2xl border border-blue-500/20 shadow-2xl">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full bg-dark-700 border border-blue-500/30 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500 transition"
              ...
              {currentRole === 'SUPER_ADMIN' && !parentAdminInfo && (
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-dark-700 border border-blue-500/30 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:border-blue-500 transition"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 py-3 rounded-lg font-semibold transition disabled:opacity-50 shadow-lg shadow-blue-500/25"
              >
